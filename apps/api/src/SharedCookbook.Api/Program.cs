...
builder.Host.UseSerilog((ctx, services, cfg) => cfg
    ...
    .Enrich.WithProperty("App", "SharedCookbook.Api")
    .WriteTo.Console());
...
builder.Services.Configure<SharedCookbook.Api.Services.AiFeatureOptions>(
    builder.Configuration.GetSection(SharedCookbook.Api.Services.AiFeatureOptions.SectionName));
...
builder.Services.AddScoped<SharedCookbook.Api.Services.RecipeTranslationService>();
...
const string CorsPolicy = "SharedCookbookDev";
