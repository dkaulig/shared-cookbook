...
public static class ChatEndpoints
{
    ...
    private static async Task TurnAsync(
        ...
        CancellationToken ct)
    {
        var logger = loggerFactory.CreateLogger("SharedCookbook.Api.Chat.Turn");
        ...
        if (!clientDisconnected && firstError is null && session.Title is null)
        {
            ...
            backgroundTasks.Run(async () =>
            {
                ...
                var bgLogger = scope.ServiceProvider
                    ...
                    .CreateLogger("SharedCookbook.Api.Chat.Title");
                try
                {
        ...
        CancellationToken ct)
    {
        ...
        var logger = loggerFactory.CreateLogger("SharedCookbook.Api.Chat");
        logger.LogInformation(
