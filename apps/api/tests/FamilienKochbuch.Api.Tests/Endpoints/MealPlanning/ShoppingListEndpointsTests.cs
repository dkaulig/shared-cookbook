...
/// </summary>
public class ShoppingListEndpointsTests : IClassFixture<FamilienKochbuchWebApplicationFactory>, IAsyncLifetime
{
    ...
    public ShoppingListEndpointsTests(FamilienKochbuchWebApplicationFactory factory)
    {
        _factory = factory;
    }
