...
/// </summary>
public class LoginRateLimitTests : IClassFixture<FamilienKochbuchWebApplicationFactory>
{
    private readonly FamilienKochbuchWebApplicationFactory _factory;

    public LoginRateLimitTests(FamilienKochbuchWebApplicationFactory factory)
    {
        _factory = factory;
    }
