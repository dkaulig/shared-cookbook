...
/// </summary>
public class ErrorResponseContractTests : IClassFixture<FamilienKochbuchWebApplicationFactory>
{
    private readonly FamilienKochbuchWebApplicationFactory _factory;

    public ErrorResponseContractTests(FamilienKochbuchWebApplicationFactory factory)
    {
        _factory = factory;
    }
