...
/// stays engaged (<see cref="FamilienKochbuchWebApplicationFactory"/>
/// normally adds it via <c>CreateRateLimitBypassingClient</c>).
/// </summary>
public class LiveSyncHubRateLimitTests : IClassFixture<FamilienKochbuchWebApplicationFactory>
{
    private readonly FamilienKochbuchWebApplicationFactory _factory;

    public LiveSyncHubRateLimitTests(FamilienKochbuchWebApplicationFactory factory)
    {
        _factory = factory;
    }
