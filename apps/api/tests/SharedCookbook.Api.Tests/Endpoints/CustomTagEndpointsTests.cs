...
/// </summary>
public class CustomTagEndpointsTests : IClassFixture<SharedCookbookWebApplicationFactory>, IAsyncLifetime
{
    private readonly SharedCookbookWebApplicationFactory _factory;
    private HttpClient _client = null!;

    public CustomTagEndpointsTests(SharedCookbookWebApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    public async Task CreateTag_Returns_400_On_Duplicate()
    {
        ...
        var err = (await second.Content.ReadFromJsonAsync<SharedCookbook.Api.Services.ErrorResponse>())!;
    ...
    public async Task DeleteTag_400_When_Deleting_Global_Tag()
    {
        ...
        var err = (await del.Content.ReadFromJsonAsync<SharedCookbook.Api.Services.ErrorResponse>())!;
