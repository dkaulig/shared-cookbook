...
/// </summary>
public class InviteEndpointsTests : IClassFixture<SharedCookbookWebApplicationFactory>, IAsyncLifetime
{
    private readonly SharedCookbookWebApplicationFactory _factory;
    private HttpClient _client = null!;

    public InviteEndpointsTests(SharedCookbookWebApplicationFactory factory)
    {
        _factory = factory;
    }
