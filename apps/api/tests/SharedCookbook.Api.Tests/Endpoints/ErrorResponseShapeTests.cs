...
/// </summary>
public class ErrorResponseShapeTests : IClassFixture<SharedCookbookWebApplicationFactory>
{
    private readonly SharedCookbookWebApplicationFactory _factory;
    private readonly HttpClient _client;

    public ErrorResponseShapeTests(SharedCookbookWebApplicationFactory factory)
    {
        _factory = factory;
