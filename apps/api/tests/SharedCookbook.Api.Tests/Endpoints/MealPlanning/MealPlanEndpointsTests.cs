...
/// </summary>
public class MealPlanEndpointsTests : IClassFixture<SharedCookbookWebApplicationFactory>, IAsyncLifetime
{
    ...
    public MealPlanEndpointsTests(SharedCookbookWebApplicationFactory factory)
    {
        _factory = factory;
    }
