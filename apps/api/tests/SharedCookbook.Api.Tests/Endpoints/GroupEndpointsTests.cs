...
/// </summary>
public class GroupEndpointsTests : IClassFixture<SharedCookbookWebApplicationFactory>, IAsyncLifetime
{
    private readonly SharedCookbookWebApplicationFactory _factory;
    private HttpClient _client = null!;

    public GroupEndpointsTests(SharedCookbookWebApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    public async Task DeleteGroup_PrivateSammlung_Returns_400_With_Protected_Code()
    {
        ...
        var error = await delete.Content.ReadFromJsonAsync<SharedCookbook.Api.Services.ErrorResponse>();
    ...
    public async Task Invite_AlreadyMember_Returns_400()
    {
        ...
        var body = await invite.Content.ReadFromJsonAsync<SharedCookbook.Api.Services.ErrorResponse>();
    ...
    public async Task Invite_AlreadyPending_Returns_400()
    {
        ...
        var body = await second.Content.ReadFromJsonAsync<SharedCookbook.Api.Services.ErrorResponse>();
    ...
    public async Task Leave_As_Last_Admin_Returns_400()
    {
        ...
        var body = await leave.Content.ReadFromJsonAsync<SharedCookbook.Api.Services.ErrorResponse>();
        Assert.Equal("last_admin", body!.Code);
    }
