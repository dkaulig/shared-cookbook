...
/// </summary>
public class AccountEndpointsTests : IClassFixture<SharedCookbookWebApplicationFactory>, IAsyncLifetime
{
    private readonly SharedCookbookWebApplicationFactory _factory;
    private HttpClient _client = null!;

    public AccountEndpointsTests(SharedCookbookWebApplicationFactory factory)
    {
        _factory = factory;
    }
