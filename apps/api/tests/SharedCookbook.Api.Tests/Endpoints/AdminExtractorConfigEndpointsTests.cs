...
/// flow. Uses the shared <see cref="SharedCookbookWebApplicationFactory"/>
    ...
    : IClassFixture<SharedCookbookWebApplicationFactory>, IAsyncLifetime
{
    ...
    public AdminExtractorConfigEndpointsTests(SharedCookbookWebApplicationFactory factory)
    {
        _factory = factory;
    }
