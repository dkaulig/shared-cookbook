...
/// </summary>
public class RecipeReimportTests : IClassFixture<SharedCookbookWebApplicationFactory>, IAsyncLifetime
{
    private readonly SharedCookbookWebApplicationFactory _factory;
    private HttpClient _client = null!;

    public RecipeReimportTests(SharedCookbookWebApplicationFactory factory)
    {
        _factory = factory;
    }
