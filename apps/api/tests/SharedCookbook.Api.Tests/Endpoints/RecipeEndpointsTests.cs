...
/// </summary>
public class RecipeEndpointsTests : IClassFixture<SharedCookbookWebApplicationFactory>, IAsyncLifetime
{
    private readonly SharedCookbookWebApplicationFactory _factory;
    private HttpClient _client = null!;

    public RecipeEndpointsTests(SharedCookbookWebApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    /// (which would advance the shared <see cref="SharedCookbookWebApplicationFactory.Clock"/>
        ...
        DateTimeOffset? baseUpdatedAt = null)
    {
        ...
        for (var i = 0; i < titles.Length; i++)
        {
            var recipe = new SharedCookbook.Domain.Entities.Recipe(
                ...
                SharedCookbook.Domain.Enums.RecipeSourceType.Manual, null,
