...
/// </summary>
public class RatingEndpointsTests : IClassFixture<SharedCookbookWebApplicationFactory>, IAsyncLifetime
{
    private readonly SharedCookbookWebApplicationFactory _factory;
    private HttpClient _client = null!;

    public RatingEndpointsTests(SharedCookbookWebApplicationFactory factory)
    {
        _factory = factory;
    }
