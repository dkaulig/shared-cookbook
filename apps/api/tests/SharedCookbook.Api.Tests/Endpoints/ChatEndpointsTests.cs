...
/// </summary>
public class ChatEndpointsTests : IClassFixture<SharedCookbookWebApplicationFactory>, IAsyncLifetime
{
    private readonly SharedCookbookWebApplicationFactory _factory;
    private HttpClient _client = null!;

    public ChatEndpointsTests(SharedCookbookWebApplicationFactory factory)
    {
        _factory = factory;
    }
    ...
    private async Task ResetAsync()
    {
        ...
        if (flag is null)
        {
            db.ExtractorConfigs.Add(new SharedCookbook.Domain.Entities.ExtractorConfig(
                ChatEndpoints.FeatureFlagKey,
                "true",
                SharedCookbook.Domain.Entities.ExtractorConfigValueType.Bool,
    ...
    /// Exercises the real
    /// <see cref="SharedCookbook.Api.Services.ExtractorConfigReader"/>
