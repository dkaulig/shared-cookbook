...
/// </summary>
public class SharedCookbookWebApplicationFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    /// <summary>PV1 — if set, the default <see cref="SharedCookbook.Api.Hubs.ILiveSyncPublisher"/>
    ...
    private SharedCookbook.Api.Hubs.ILiveSyncPublisher? _publisherOverride;
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureServices(services =>
        {
            ...
            services.PostConfigure<SharedCookbook.Api.Services.ExtractorOptions>(opts =>
            {
            ...
            {
                services.RemoveAll<SharedCookbook.Api.Hubs.ILiveSyncPublisher>();
    ...
    public SharedCookbookWebApplicationFactory WithSmtpConfig(
    ...
    public SharedCookbookWebApplicationFactory WithoutFakeEmailSender()
    {
    ...
    public SharedCookbookWebApplicationFactory WithPublisher(
        SharedCookbook.Api.Hubs.ILiveSyncPublisher publisher)
    {
    ...
    public SharedCookbookWebApplicationFactory WithAiConfig(bool enabled, string provider)
    {
        _aiEnabled = enabled;
