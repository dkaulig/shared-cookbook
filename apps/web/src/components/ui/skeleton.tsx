 ...
 * picks up the themed neutral tint in light mode and the stone-800
 * equivalent in `.dark`. Previously this was a hardcoded
 * `bg-stone-200/80` which read cold on the themed background.
 */
